...
'NHL Autolife
Public Function BuscaSlotInventario(item As String) As Long
    Dim slot As Long
    BuscaSlotInventario = 0
    For slot = 1 To Inventario.MaxObjs
        If (StrComp(item, Inventario.ItemName(slot)) = 0) Then
            BuscaSlotInventario = slot
        End If
    Next
End Function
